...
def cadastro(request):
    """ Cadastra uma nova pessoa nos sistema """
...
def dashboard(request):
    """ Carrega um dashboard de um usuario logado no sistema """
...
def senhas_nao_sao_iguais(senha, senha2):
    """ Verifica se as senhas são iguais na hora de realizar os cadastro """
    return senha != senha2
